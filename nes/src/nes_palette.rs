...
mod nes {
    ...
    const ENTRIES_RP2C04_0001: [i16; 64] = [
    ...
    const ENTRIES_RP2C04_0002: [i16; 64] = [
    ...
    const ENTRIES_RP2C04_0003: [i16; 64] = [
    ...
    const ENTRIES_RP2C04_0004: [i16; 64] = [
    ...
    impl NesPalette {
        ...
        fn setup_palette(&mut self, entries: [i16; 64], palette: Palette)
        {
            for index in 0..64 {
                let entry: i16 = entries[index];
                let blue: u8 = (entry % 10) as u8;
                let green: u8 = ((entry % 100 - blue as i16) / 10) as u8;
                let red: u8 = ((entry - green as i16 - blue as i16) / 100) as u8;
                self.set_color(red, green, blue, index as usize, palette as usize);
            }
        }
